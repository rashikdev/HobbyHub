    ...
    <div className="my-12 md:p-4 p-2 bg-base-300 rounded-xl text-center">
      ...
      <div className="rounded-md overflow-hidden">
        <Marquee pauseOnHover={true}>
          <div className="bg-gradient-to-br from-orange-300  to-green-400 shadow-lg p-6 rounded-lg md:w-72 w-70 mr-3 md:mr-6 skew-x-6">
          ...
          <div className="bg-gradient-to-br from-red-400  to-red-200 shadow-lg p-6 rounded-lg md:w-72 w-70 mr-3 md:mr-6 skew-x-6">
            <p className="italic text-gray-700">
          ...
          <div className="bg-gradient-to-br from-orange-300  to-indigo-400 shadow-lg p-6 rounded-lg md:w-72 w-70 mr-3 md:mr-6 skew-x-6">
            <p className="italic text-gray-700">
          ...
          <div className="bg-gradient-to-br from-purple-300  to-rose-500 shadow-lg p-6 rounded-lg md:w-72 w-70 mr-3 md:mr-6 skew-x-6">
            <p className="italic text-gray-700">
          ...
          <div className="bg-gradient-to-br from-indigo-500  to-green-400 shadow-lg p-6 rounded-lg md:w-72 w-70 mr-3 md:mr-6 skew-x-6">
            <p className="italic text-gray-700">
              “HobbyHub helped me stay active by joining a local hiking club.
              Every weekend is now an adventure!”
            </p>
